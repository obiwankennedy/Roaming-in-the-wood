...
\item Les purs : les loup-garous qui refusèrent de prendre part à la mort de Père-Loup
...
C’est à peu près à ce moment que ta sœur aînée a pété un câble ; elle disparut et ne répondit plus à tes appels.\\  Une semaine avant une le vernissage d’une exposition dans une galerie de la ville, elle vint te voir pour te demander d’arrêter te peindre tes rêves, car tu révélais des choses qui ne pouvaient pas être dévoilées au public. Tu ne compris pas et l’envoya valser.\\
...
Mais le plus étrange, ce sont tes absences. Ce samedi matin, tu t'es réveillée dans ta salle de classe. Tu n'as pas compris ce que tu faisais là et tu ne te souviens plus du tout des événements de la nuit d'hier. Ces trous de mémoire sont de plus en plus longs et inquiétants. \\
Avis :\\
...
\underline{\Jessica}: ta sœur, elle est la clé de voûte de cette meute, son âme. Tu regrettes un peu.\\
}
...
-Le scénario commence le samedi soir, le dimanche matin, il y a la messe, le dimanche soir la tempête, lundi les conséquences de la tempête et à midi le sénateur texan. Le lundi comme le mardi, il y a peu d'enfants en classe. 
