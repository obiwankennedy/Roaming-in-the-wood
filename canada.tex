...
\item Les purs : Loup garous qui refusèrent de prendre par à la mort de Père-Loup
...
\item \Leonard : pas d'armes à l'exception d'un petit couteau.
...
Il l'entoure de flamme noire, et la remercie (en privé) pour son travail, elle gagne un don «Peur mortelle»  qui pétrifie de peur quelqu'un. La personne est libérée à la désactivation du pouvoir ou s'il subit des dégâts (plus d'information voir section \ref{Peur_mortelle}).\\
...
Il est possible d'interroger l'esprit de la maison pour obtenir les infos (voir \ref{Christopher}). Il est possible que les enfants du maire soient victimes des peurs. 
...
Voici les principales raisons de sa présence.
\begin{itemize}
